...
<body>
    ...
    <div class="container">
        <div class="jumbotron">
            ...
            <p>More info</p>
            <p class="lead">
                <a class="btn btn-primary btn-lg" href="Jumbo action link" role="button">Info</a>
            </p>
        </div>
            ...
            <div class="col-9">
                <div>
                    ...
                    <p class="open-sans-judul fontintro">
                        ...
                        aset strategis Indonesia, sejalan dengan agenda jangka panjang transformasi ekonomi nasional.
                    </p>
                </div>
            </div>
            <div class="col-3">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <p>Sebagai badan investasi negara, kami menyediakan platform terpercaya bagi investor global
                            untuk mengakses
                            potensi ekonomi Indonesia yang sangat luas dan menciptakan nilai tambah yang berkelanjutan.
                        </p>
                    </div>
                </div>
                <div class="row">
